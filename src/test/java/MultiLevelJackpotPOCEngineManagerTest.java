...
public class MultiLevelJackpotPOCEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MultiLevelJackpotPOCEngineManagerTest.class);
		logger.setLevel(Level.DEBUG);
		gameParams = XMLUtil.parseResource("paymodel/MultiLevelJackpotPOCIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MultiLevelJackpotPOCIW/InitOutcome.xml").getDocumentElement();
